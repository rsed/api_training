...
CURLB1="25OE4ROCCCVKS"
CURLB2="25OE4ROCCCVKS"
#EIP1="1SFPJ9HH48PF9"
#EIP2="B50R3SRMABS0D"
#CLOUD="1"
...
#CURLB1=`grep Location output/16_ServerLB-Launch.sh.out|cut -c 35-|tr -d '\r' | sed -n 1p`
#CURLB2=`grep Location output/16_ServerLB-Launch.sh.out|cut -c 35-|tr -d '\r' | sed -n 2p`
...
-d ip_address_binding[instance_href]=/api/clouds/$CLOUD/instances/$CURLB1 \
...
curl -i -H X-API-Version:1.5 -b ~/mycookie -X POST \
-d ip_address_binding[instance_href]=/api/clouds/$CLOUD/instances/$CURLB2 \
